...
- name: Data.gov API Get Datasets Checkurl
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-checkurl-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-checkurl-get-postman.md
x-common:
- type: x-blog
