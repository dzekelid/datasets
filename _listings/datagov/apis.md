...
- name: Data.gov API Get Datasets Suggest
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-suggest-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-suggest-get-postman.md
x-common:
- type: x-blog
