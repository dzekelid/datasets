...
- name: Data.gov API Get Datasets Frequencies
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-frequencies-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/datasets-frequencies-get-postman.md
x-common:
- type: x-blog
