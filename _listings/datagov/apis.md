...
- name: Data.gov API Get Organizations Org Datasets
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/organizations-org-datasets-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/datagov/organizations-org-datasets-get-postman.md
x-common:
- type: x-blog
