...
- name: Global Change Information System API List datasets.
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/globalchange-gov/dataset-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/globalchange-gov/dataset-get-openapi.md
- name: Global Change Information System API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/datasets/master/_listings/globalchange-gov/openapi.md
x-common:
- type: x-developer
